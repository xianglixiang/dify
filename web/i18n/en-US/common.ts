const translation = {
  ...
  admin: {
    workspaces: {
      ...
      deleteButton: 'Delete',
      deleteModalTitle: 'Confirm Delete Workspace',
      deleteConfirmText: 'Are you sure you want to delete workspace \'{{workspaceName}}\'? This action may not be undone.',
      confirmDeleteButton: 'Confirm Delete',
      createSuccessToast: 'Workspace \'{{name}}\' created successfully.',
      createErrorToastFallback: 'Creation failed, please try again later.',
      createErrorToastGeneral: 'Failed to create workspace.',
      deleteSuccessToast: 'Workspace \'{{name}}\' deleted successfully.',
      deleteErrorToastFallback: 'Deletion failed, please try again later.',
      deleteErrorToastGeneral: 'Failed to delete workspace.',
      nameNotEmptyToast: 'Workspace name cannot be empty.',
      loadingWorkspaces: 'Loading workspaces...',
      noWorkspaces: 'No workspaces available to manage.',
      accessDenied: 'Access Denied. You must be an admin to view this page.',
