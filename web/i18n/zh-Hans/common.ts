const translation = {
  ...
  admin: {
    workspaces: {
      manageTitle: '管理工作空间',
      createWorkspace: '创建工作空间',
      createModalTitle: '创建新的工作空间',
      workspaceNameLabel: '工作空间名称',
      workspaceNamePlaceholder: '请输入工作空间名称',
      cancelButton: '取消',
      submitButton: '提交',
      tableHeaderName: '名称',
      tableHeaderID: 'ID',
      ...
      deleteButton: '删除',
      deleteModalTitle: '确认删除工作空间',
      deleteConfirmText: '您确定要删除工作空间 \'{{workspaceName}}\' 吗？此操作可能无法撤销。',
      confirmDeleteButton: '确认删除',
      createSuccessToast: '工作空间 \'{{name}}\' 创建成功。',
      createErrorToastFallback: '创建失败，请稍后重试。',
      createErrorToastGeneral: '创建工作空间失败。',
      deleteSuccessToast: '工作空间 \'{{name}}\' 已删除。',
      deleteErrorToastFallback: '删除失败，请稍后重试。',
      deleteErrorToastGeneral: '删除工作空间失败。',
      nameNotEmptyToast: '工作空间名称不能为空。',
      loadingWorkspaces: '正在加载工作空间...',
      noWorkspaces: '没有可管理的工作空间。',
      accessDenied: '访问被拒绝。您必须是管理员才能查看此页面。',
